...
$GLOBALS['TPL_CFG']['Partner'] = array(
    'Name' => 'One True Thing Media',
    'Contact' => 'http://www.onetruethingmedia.com/contact-us/',
    'Email' => 'onetruethingmedia@gmail.com',
);
...
$GLOBALS['TPL_CFG']['LogoWidth'] = 150;
$GLOBALS['TPL_CFG']['LogoHeight'] = 50;

// Recommended dimensions of carousel images
$GLOBALS['TPL_CFG']['SlideShowWidth'] = 980;
$GLOBALS['TPL_CFG']['SlideShowHeight'] = 450;
...
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesStorewideThumbnail_width']       = 300;
$GLOBALS['TPL_CFG']['ConfigDefaults']['ProductImagesStorewideThumbnail_height']      = 550;
...
$GLOBALS['TPL_CFG']['ConfigDefaults']['CustomersAlsoViewedCount'] = 4;
$GLOBALS['TPL_CFG']['ConfigDefaults']['HomeFeaturedProducts']     = 6;
$GLOBALS['TPL_CFG']['ConfigDefaults']['HomeNewProducts']          = 6;
...
$GLOBALS['TPL_CFG']['DemoStore'] = "http://aberdeen-demo.mybigcommerce.com";

// Is theme enabled? (i.e. visible in Theme Store)
$GLOBALS['TPL_CFG']['Enabled'] = Store_Feature::isEnabled('AberdeenTheme');
